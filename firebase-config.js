...
// Correctif important pour les réseaux mobiles (4G/opérateurs) qui bloquent
// parfois le type de connexion utilisé par défaut par Firestore, provoquant
// l'erreur "client is offline" même avec Internet qui fonctionne. Cette
// ligne fait basculer automatiquement vers un mode de connexion compatible
// avec la plupart des réseaux restrictifs.
db.settings({
